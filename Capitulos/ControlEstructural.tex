...
\begin{align*}
    \tenq{M}\tend{\ddot{u}} + \tenq{C}\tend{\dot{u}} + \tenq{K}\tend{u} + \tend{f}_p = \tend{f}_a + \tend{f}_e
\end{align*}

Donde $\tend{f}_p$ es la fuerza pasiva, $\tend{f}_a$ (actuadores) es la fuerza activa y $\tend{f}_e$ es la fuerza externa (sismo).
...
\begin{align*}
    \tenq{M}\tend{\ddot{u}} + \tenq{C}\tend{\dot{u}} + \tenq{K}\tend{u} + \tend{f}_p = \cancelto{0}{\tend{f}_a} + \tend{f}_e
\end{align*}
