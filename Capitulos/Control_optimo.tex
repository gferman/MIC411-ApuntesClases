...
\begin{align*}
    \tetxt{Ec. HJB: }\quad -V_t(x,t) = \min_{u\in\mathcal{U}}\Big\{l(x,u,t)+\big(\nabla_x V(x,t)\big)^\top f(x,u,t)\Big\}
\end{align*}
...
Sea el sistema LTI autónomo (u=0)
\begin{align*}
